...
static func _create_brute_force() -> PassiveTrait:
    ...
    pasive_trait.effects = [
        Effect.new("damage_bonus", "add", 0.25, ["physical"])
    ]
    pasive_trait.synergy_deity_ids = ["god_of_war"]
    return pasive_trait
...
static func _create_iron_body() -> PassiveTrait:
    ...
    pasive_trait.synergy_deity_ids = ["goddess_of_wisdom"]
    return pasive_trait
...
static func _create_last_stand() -> PassiveTrait:
    ...
    pasive_trait.conditions = [condition]
    return pasive_trait
...
static func _create_regeneration() -> PassiveTrait:
    ...
    pasive_trait.synergy_deity_ids = ["goddess_of_life"]
    return pasive_trait
...
static func _create_stamina_efficiency() -> PassiveTrait:
    ...
    pasive_trait.synergy_deity_ids = ["god_of_commerce"]
    return pasive_trait
...
static func _create_defense_mastery() -> PassiveTrait:
    ...
    var condition = EffectCondition.new()
    condition.required_stances = ["defend"]
    pasive_trait.conditions = [condition]
    pasive_trait.synergy_deity_ids = ["goddess_of_wisdom"]
    return pasive_trait
...
static func _create_perfect_balance() -> PassiveTrait:
    ...
    pasive_trait.synergy_deity_ids = ["god_of_balance"]
    return pasive_trait